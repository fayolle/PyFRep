...
def GaussianCurvature(f, v):
    ...
    Hstar_f[:,0,0] = H_ft[:,1,1]*H_ft[:,2,2] - H_ft[:,1,2]*H_ft[:,2,1]
    Hstar_f[:,1,1] = H_ft[:,0,0]*H_ft[:,2,2] - H_ft[:,0,2]*H_ft[:,2,0]
    Hstar_f[:,2,2] = H_ft[:,0,0]*H_ft[:,1,1] - H_ft[:,0,1]*H_ft[:,1,0]
    Hstar_f[:,1,0] = H_ft[:,0,2]*H_ft[:,2,1] - H_ft[:,0,1]*H_ft[:,2,2]
    Hstar_f[:,2,0] = H_ft[:,0,1]*H_ft[:,1,2] - H_ft[:,0,2]*H_ft[:,1,1]
    Hstar_f[:,0,1] = H_ft[:,1,2]*H_ft[:,2,0] - H_ft[:,1,0]*H_ft[:,2,2]
    Hstar_f[:,2,1] = H_ft[:,1,0]*H_ft[:,0,2] - H_ft[:,0,0]*H_ft[:,1,2]
    Hstar_f[:,0,2] = H_ft[:,1,0]*H_ft[:,2,1] - H_ft[:,1,1]*H_ft[:,2,0]
    Hstar_f[:,1,2] = H_ft[:,0,1]*H_ft[:,2,0] - H_ft[:,0,0]*H_ft[:,2,1]
